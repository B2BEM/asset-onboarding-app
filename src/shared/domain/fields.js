...
// Field hover definitions. Criticality / Condition / Life-cycle / Replacement cost use B2BEM working
// definitions (supplied 2026-07-07); Asset function keeps its ISO 55000 framing.
const FIELD_INFO={ make:'Manufacturer — the OEM company that made the item.', supplier:'Supplier — the vendor used to purchase the item.',
  isoCriticality:'The relative importance of this asset — score 1–7.',
  isoCondition:'Current condition — score 1–7.',
  isoLifecycle:'Expected life of equipment in years.',
  ...
  isoValue:'Cost of full replacement, including labour.' };
